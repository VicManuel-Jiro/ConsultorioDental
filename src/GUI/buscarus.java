 ...
 * @author Jiro
 */
public class buscarus extends VentanaControladaAbstract {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        final String sql = "SELECT id,usuario from usuarios where usuario LIKE ? and id!=1 and usuario!=? order by id DESC";
        ...
        try {
            ...
            st.setString(2, this.superCtrl.getUser());
    ...
    public void actionPerformed(ActionEvent e) {
        //throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
            ...
            if (!"1".equals(dato)){
                ...
                try {
                    (this.st = cn.prepareStatement(sql)).setString(1, dato);
