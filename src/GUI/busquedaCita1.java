 ...
 * @author Jiro
 */
public class busquedaCita1 extends VentanaControladaAbstract {
    ...
    public busquedaCita1() {
        ...
        JMenuItem menuItem3 = new JMenuItem("Crear");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(busquedaCita1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new busquedaCita1().setVisible(true);
            }
        });
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("Crear")) {
            ...
            try {
                ...
                this.st = cn.prepareStatement("select count(id_paciente) as conteo from consultas where id_paciente=?");
                this.st.setString(1, this.superCtrl.getClave());
                this.rt = this.st.executeQuery();
                if (this.rt.next()) {
                    antes = this.rt.getInt("conteo");
                }
                if (antes != 0) {
                    JOptionPane.showMessageDialog(this, "Ya existe una cita para este paciente, modifiquela o eliminela", "Atencion", 1);
                }else if(antes==0){
                    this.limpiar();
                       this.superCtrl.muestracita(true);
                }
